...
public class BuildScanServiceMessageInjector extends AgentLifeCycleAdapter {
    ...
    private static final String GRADLE_ENTERPRISE_EXT_MAVEN = "gradle-enterprise-maven-extension-1.15.1.jar";
    private static final String COMMON_CUSTOM_USER_DATA_EXT_MAVEN = "common-custom-user-data-maven-extension-1.11.jar";
    ...
    private String getMavenInvocationArgs(BuildRunnerContext runner) {
        if (runner.isVirtualContext()) {
            LOG.warn("Skipping Gradle Enterprise Extension injection (not supported in virtual contexts)");
            return "";
        }
