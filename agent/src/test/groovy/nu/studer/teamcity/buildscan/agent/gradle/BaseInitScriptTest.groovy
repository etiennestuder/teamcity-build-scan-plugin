...
class BaseInitScriptTest extends Specification {
    ...
    static final JdkCompatibleGradleVersion GRADLE_7_6 = new JdkCompatibleGradleVersion(GradleVersion.version('7.6.4'), 8, 19)
    static final JdkCompatibleGradleVersion GRADLE_8_0 = new JdkCompatibleGradleVersion(GradleVersion.version('8.0.2'), 8, 19)
    static final JdkCompatibleGradleVersion GRADLE_8_X = new JdkCompatibleGradleVersion(GradleVersion.version('8.13'), 8, 21)
