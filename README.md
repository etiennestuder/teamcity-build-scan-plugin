...
> **This plugin is no longer maintained. The functionality is now maintained and enhanced in Gradle's [Develocity TeamCity plugin](https://github.com/gradle/develocity-teamcity-plugin).**
