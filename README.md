...
> **This plugin is no longer maintained. The functionality is now maintained and enhanced in Gradle's [Develocity TeamCity plugin]([url](https://github.com/gradle/develocity-teamcity-plugin)).**
