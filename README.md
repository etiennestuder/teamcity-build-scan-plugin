...
> **This plugin is no longer maintained. Use Gradle's [Develocity TeamCity plugin](https://plugins.jetbrains.com/plugin/27005-develocity-integration) as an alternative.**
